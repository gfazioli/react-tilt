...
const URL = "https://gfazioli.github.io/react-tilt/";
const TEXT =
  "@gfazioli/react-tilt — interactive 3D tilt cards for React: parallax, glare, gyroscope & spring physics. Zero runtime dependencies.";
